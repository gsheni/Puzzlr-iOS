...
//  Copyright © 2016 WFU. All rights reserved.
...
class ViewController: UIViewController, FBSDKLoginButtonDelegate  {
    ...
    func setupSubviews() {
        ...
        showFriendsButton.addTarget(self, action: #selector(ViewController.showFriends), forControlEvents: .TouchUpInside)
    ...
    func loginButtonDidLogOut(loginButton: FBSDKLoginButton!) {
          userImageView.image = UIImage(named: ("white_box"))
          nameLabel.text = " "
    }
